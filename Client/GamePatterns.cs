...
public class GamePatterns
{
    ...
    private static SortedDictionary<string, uint> PatternsDict = new()
    {
        ...
        { "Column 1", 0b00000001000010000100001000010000 },
        { "Column 2", 0b00000000100001000010000100001000 },
        { "Column 3", 0b00000000010000100001000010000100 },
        { "Column 4", 0b00000000001000010000100001000010 },
        { "Column 5", 0b00000000000100001000010000100001 },
    ...
    public static IEnumerable<uint> GetPatternSet(string patternName)
    {
        ...
        switch (patternName)
        {
            case Default:
                ...
                yield return PatternsDict["Column 1"];
                yield return PatternsDict["Column 2"];
                yield return PatternsDict["Column 3"];
                yield return PatternsDict["Column 4"];
                yield return PatternsDict["Column 5"];
